...
<script src="https://cdn.jsdelivr.net/npm/coolhand@0.6.1/dist/coolhand.min.js"></script>
...
```html
<script src="https://github.com/Coolhand-Labs/coolhand-js/releases/download/v0.6.1/coolhand.min.js"></script>
```
...
The SDK version string (e.g. `"0.6.1"`).

**Example:**
```javascript
console.log(CoolhandJS.version); // "0.6.1"
```
