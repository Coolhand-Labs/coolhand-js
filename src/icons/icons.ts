...
<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="coolhand-icon-trigger">
...
<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="coolhand-icon-up">
  <path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3H14Z"/>
  <path d="M7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3"/>
</svg>
`;
...
<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="coolhand-icon-down">
  <path d="M10 15v4a3 3 0 0 0 3 3l4-9V2H5.72a2 2 0 0 0-2 1.7l-1.38 9a2 2 0 0 0 2 2.3H10Z"/>
  <path d="M17 2h2.67A2.31 2.31 0 0 1 22 4v7a2.31 2.31 0 0 1-2.33 2H17"/>
</svg>
`;
...
<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="coolhand-icon-neutral">
...
<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="coolhand-icon-close">
