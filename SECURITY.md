...
Only the latest published version of `coolhand` on npm is supported with security fixes.
...
- [GitHub Security Advisories](https://github.com/Coolhand-Labs/coolhand-js/security/advisories/new)
